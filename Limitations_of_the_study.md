...
2) These results are specific to the selcted samples/cohorts/studies. A different set of cohorts might yield different results.

3) There are multiple confounders involved, and accounting and adjusting for all of them is beyond the scope of this project.
