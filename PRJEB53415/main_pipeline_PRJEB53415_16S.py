...
os.system(                              #downloading sra files
    "dos2unix SRA_Accesion_list_PRJEB53415.txt && "
    "cat SRA_Accesion_list_PRJEB53415.txt | parallel -j 4 'mamba run -n sra prefetch -p -O $PWD/sra'"
)
...
os.system(
    "mamba run -n r Rscript PRJEB53415.R " 
