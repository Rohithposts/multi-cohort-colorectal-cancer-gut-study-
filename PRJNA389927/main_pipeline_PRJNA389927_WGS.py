...
import os
os.system(
"dos2unix SRA_Accesion_PRJNA389927_healthy_Batch_1.txt"
)
with open("SRA_Accesion_PRJNA389927_healthy_Batch_1.txt") as f:
    for line in f:
        acc_id = line.strip()
        os.system(
...
with open("Second_Batch_Healthy_PRJNA389927.py", "w") as f:
    f.write("""
#!/usr/bin/python3
import os
os.system(
"dos2unix SRA_Accesion_PRJNA389927_healthy_Batch_2.txt"
)
with open("SRA_Accesion_PRJNA389927_healthy_Batch_2.txt") as f:
    for line in f:
        acc_id = line.strip()
        os.system(
            f"mamba run -n sra prefetch {acc_id} && "     #accessing the SRA, installing it, and converting it to .fastq
...
with open("First_Batch_Cancer_PRJNA389927.py", "w") as f:
    f.write("""
#!/usr/bin/python3
import os
os.system(
"dos2unix SRA_Accesion_PRJNA389927_Cancer_Batch_1.txt"
)
with open("SRA_Accesion_PRJNA389927_Cancer_Batch_1.txt") as f:
    for line in f:
        acc_id = line.strip()
        os.system(
            f"mamba run -n sra prefetch {acc_id} && "     #accessing the SRA, installing it, and converting it to .fastq
...
with open("Second_Batch_Cancer_PRJNA389927.py", "w") as f:
    f.write("""
#!/usr/bin/python3
import os
os.system(
"dos2unix SRA_Accesion_PRJNA389927_Cancer_Batch_2.txt"
)
with open("SRA_Accesion_PRJNA389927_Cancer_Batch_2.txt") as f:
    for line in f:
        acc_id = line.strip()
        os.system(
            f"mamba run -n sra prefetch {acc_id} && "     #accessing the SRA, installing it, and converting it to .fastq
...
os.system(
    "python3 First_Batch_Healthy_PRJNA389927.py & "
    "python3 Second_Batch_Healthy_PRJNA389927.py & "
    "python3 First_Batch_Cancer_PRJNA389927.py & "
    "python3 Second_Batch_Cancer_PRJNA389927.py & "
    "wait"
)
os.system(                                                #merging the output to get a final table
    "mamba run -n metaphlan merge_metaphlan_tables.py metaphlan_output_txt/*.txt > PRJNA389927_abundunce_table.tsv" 
)
