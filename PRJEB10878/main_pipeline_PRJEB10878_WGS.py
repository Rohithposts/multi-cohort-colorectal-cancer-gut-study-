...
import os
os.system(
"dos2unix SRA_Accesion_PRJEB10878_healthy_Batch_1.txt"
)
...
import os
os.system(
"dos2unix SRA_Accesion_PRJEB10878_healthy_Batch_2.txt"
)
...
import os
os.system(
"dos2unix SRA_Accesion_PRJEB10878_Cancer_Batch_1.txt"
)
...
import os
os.system(
"dos2unix SRA_Accesion_PRJEB10878_Cancer_Batch_2.txt"
)
...
os.system(
    "python3 First_Batch_Healthy_PRJEB10878.py & "
    "python3 Second_Batch_Healthy_PRJEB10878.py & "
    "python3 First_Batch_Cancer_PRJEB10878.py & "
    "python3 Second_Batch_Cancer_PRJEB10878.py & "
    "wait"
)
